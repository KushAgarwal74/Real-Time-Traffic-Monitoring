    ...
    with get_db_connection() as conn:
        with conn.cursor() as cur:
            ...
            print(
                ...
                frame_id,
                int(total_count),
                int(detections.get("car", 0)),
                int(detections.get("truck", 0)),
                int(detections.get("buse", 0)),
                int(detections.get("motorcycle", 0)),
            ),
            cur.execute(
                """
                INSERT INTO traffic_breakdown (
                    event_time,
                    frame_id,
                    total_vehicles,
                    cars,
